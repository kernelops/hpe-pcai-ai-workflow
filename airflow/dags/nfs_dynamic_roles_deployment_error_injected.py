"""
Error-injected DAG for dynamically distributing NFS Server and Client roles at runtime.
Structure intentionally mirrors nfs_dynamic_roles_deployment.
"""
import os
import requests
...
with DAG(
    dag_id='nfs_dynamic_roles_deployment_error_injected',
    default_args=default_args,
    description='Dynamically assign Server and Client roles for NFS deployment (error-injected)',
...
echo "INJECTED_ERROR: forced failure after file write validation" >&2
exit 44
        '''
    )
