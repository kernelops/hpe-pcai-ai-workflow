...
with DAG(
    dag_id='nfs_dynamic_roles_deployment_error_injected_deploy_server',
    default_args=default_args,
    description='Dynamically assign Server and Client roles for NFS deployment (error at deploy_server)',
...
echo "INJECTED_ERROR: forcing failure in deploy_server" >&2
exit 45
        '''
    )
