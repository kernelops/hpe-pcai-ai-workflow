...
Injection point: create_storage_node.
"""
import os
import requests
...
with DAG(
    dag_id='distributed_minio_deployment_error_injected_create_node',
    default_args=default_args,
    description='Deploy MinIO on worker nodes via SSH (error at create_storage_node)',
