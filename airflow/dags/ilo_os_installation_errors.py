...
error_scenarios = [
    {
        "dag_id": "ilo_error_01_cleanup_failure",
    ...
    {
        "dag_id": "ilo_error_02_pkg_install_fail",
    ...
    {
        "dag_id": "ilo_error_03_iso_download_404",
    ...
    {
        "dag_id": "ilo_error_04_iso_permission_denied",
        "task": "download_os_image",
    ...
    {
        "dag_id": "ilo_error_05_virt_install_invalid_arg",
    ...
    {
        "dag_id": "ilo_error_06_virt_install_missing_iso",
        "task": "provision_target_vm",
    ...
    {
        "dag_id": "ilo_error_07_monitor_boot_timeout",
    ...
    {
        "dag_id": "ilo_error_08_monitor_wrong_vm_name",
        "task": "monitor_os_boot",
    ...
    {
        "dag_id": "ilo_error_09_validate_cpu_mismatch",
    ...
    {
        "dag_id": "ilo_error_10_validate_mem_mismatch",
        "task": "validate_vm_resources",
